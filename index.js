...
registerInteractionHandler(client, commands, sessions, {
  ...
  CUSTOM_DETAILS_BUTTON_ID: askToPlayService.CUSTOM_DETAILS_BUTTON_ID,
  CUSTOM_DETAILS_MODAL_PREFIX: askToPlayService.CUSTOM_DETAILS_MODAL_PREFIX,
  CUSTOM_GAME_INPUT_ID: askToPlayService.CUSTOM_GAME_INPUT_ID,
  CUSTOM_ACTIVITY_INPUT_ID: askToPlayService.CUSTOM_ACTIVITY_INPUT_ID,
  updateAskMessage,
